...
public class GeospatialRunner implements CommandLineRunner {
	...
	private static final Logger logger = LoggerFactory.getLogger(GeospatialRunner.class.getName());
...
//		logger.debug("## Find all locations which are 40 to 50 kilometers away from 'Winterfell'");
...
//		logger.debug("## Find all locations within a given polygon");
